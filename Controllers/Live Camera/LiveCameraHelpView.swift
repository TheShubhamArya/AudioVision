        ...
        NavigationView{
            VStack {
                ...
                if didTapNext == 0 {
                    ...
                    CommandCell(image: "speaker.slash.fill",headline: "\"Pause\"",subtitle: "This command stops reading the text to you. This command can only be used when you STOP live detection and READ the text.", prevValue: prevValue, didTapNext: didTapNext)
                } else if didTapNext == 4 {
                    CommandCell(image: "playpause",headline: "\"Continue\"",subtitle: "This continues reading the text you PAUSED, from the place it stopped.", prevValue: prevValue, didTapNext: didTapNext)
